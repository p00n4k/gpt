...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Case 4: Test science plan
        System.out.println("\nCase 4: Test science plan");
        System.out.println(ocs.testSciencePlan(ocs.getSciencePlanByNo(2)));
        System.out.println(ocs.getAllSciencePlans());

        // Case 5: Submit a science plan
        System.out.println("\nCase 5: Submit a science plan");
        // submit a science plan using the science plan that was tested in the previous case
        System.out.println(ocs.submitSciencePlan(ocs.getSciencePlanByNo(2)));

        // Case 6: Update a science plan status
        System.out.println("\nCase 6: Update a science plan status");
        ocs.updateSciencePlanStatus(3, SciencePlan.STATUS.COMPLETE);
        System.out.println(ocs.getSciencePlanByNo(3));

        // Case 7: Remove a science plan
        System.out.println("\nCase 7: Remove a science plan");
        ocs.deleteSciencePlanByNo(3);
        System.out.println(ocs.getAllSciencePlans());

        // Case 8: Execute a command line
        System.out.println("\nCase 8: Execute a Gemini command line's command");
        ...
        // Case 9: Install and remove the configurations
        System.out.println("\nCase 9: Install and remove the configurations");
        ...
        // Case 10: Access live view of telescope
        System.out.println("\nCase 10: Access live view of telescope");
        try {
        ...
        // Case 11: Get the astronomical data from complete science plan
        System.out.println("\nCase 11: Get the astronomical data from complete science plan");
        ...
        // Case 12: Create an observing program
        ...
        // Case 13: manage observation schedule
